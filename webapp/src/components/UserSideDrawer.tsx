...
/* HAMBURGER */
export function UserBurger({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={onClick}
...
export function UserSideDrawer({
  ...
  open: boolean;
  onClose: () => void;
  user?: { name: string; username: string; email: string; profileImage?: string };
  userId?: string;
}) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Profile Section */}
        <div className="px-6 pb-6 border-b border-gray-200 mb-4 relative">
